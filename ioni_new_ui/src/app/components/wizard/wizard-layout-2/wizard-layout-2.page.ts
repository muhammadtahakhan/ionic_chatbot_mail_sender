...
@Component({
  selector: 'cs-wizard-layout-2',
  templateUrl: 'wizard-layout-2.page.html',
  styleUrls: ['wizard-layout-2.page.scss'],
})
export class WizardLayout2Page implements OnChanges {
  @Input() data: any;
