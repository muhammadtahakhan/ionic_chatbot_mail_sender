...
@Component({
  selector: 'cs-swipe-to-dismiss-list-layout-2',
  templateUrl: 'swipe-to-dismiss-list-layout-2.page.html',
  styleUrls: ['swipe-to-dismiss-list-layout-2.page.scss'],
})
export class SwipeToDismissListLayout2Page implements OnChanges {
