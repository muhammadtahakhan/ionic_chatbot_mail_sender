...
@Component({
    selector: 'cs-register-layout-2',
    templateUrl: 'register-layout-2.page.html',
    styleUrls: ['register-layout-2.page.scss'],
})
export class RegisterLayout2Page implements OnChanges {
    @Input() data: any;
